...
//Configs arquivo
    ...
    if($deu_certo){
        $mysqli->query("INSERT INTO arquivos (nome, path, autor, referencia, metadados) VALUES ('$nomeDoArquivo', '$path', '$autor', '$referencia', '$metadados')") or die($mysqli -> error);
    }   
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="d-flex">
            <a href="projetoFinal.php" class="btn btn-danger me-5">Editar projeto</a>
        </div>
        <div class="d-flex">
    ...
    <form method="POST" enctype="multipart/form-data" action="">
        ...
        <br>
            ...
            <div class="inputBox">
                    ...
                    <label for="referencia" class="labelInput">Referências</label>
                </div>
            <br>
            <div class="inputBox">
