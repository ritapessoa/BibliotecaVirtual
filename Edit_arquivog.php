...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="d-flex">
            <a href="uploadg.php" class="btn btn-danger me-5">Voltar</a>
        </div>
    </nav>
    <br><br>
    <form action="saveEditg.php" method="POST">
            <div class="inputBox">
            ...
            <div class="inputBox">
                ...
                <br>
                <div class="inputBox">
                    <input type="text" name="metadados" id="metadados" value="<?php echo $metadados ?>" class="inputUser" >
                    <label for="metadados" class="labelInput">Data - Informações</label>
                </div>
            <br>
            <br>
            <div class="inputBox">
                    <input type="text" name="avaliacao" id="avaliacao" value="<?php echo $avaliacao ?>" class="inputUser" >
