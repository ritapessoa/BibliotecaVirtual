<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM arquivos WHERE id LIKE '%$data%' or nome LIKE '%$data%' or autor LIKE '%$data%' or referencia LIKE '%$data%' or metadados LIKE '%$data%' or avaliacao LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
...
<body>
  ...
  <thead>
    <tr>
        ...
        <th scope="col">...</th>
        <div class="d-flex">
        <a href="uploadt.php" class="btn btn-info">Enviar</a>
        <a href="upload.php" class="btn btn-info">Acessar arquivos</a>
    </div>
  ...
  <tbody>
    ...
    function searchData()
    {
        window.location = 'projetoFinal.php?search='+search.value;
    }
</script>
      </html>   